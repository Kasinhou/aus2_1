...
public class View extends JFrame {
    ...
    public View() {
        ...
        inputs.add(new JLabel("Date of Birth"));
        inputs.add(this.personBirthday);
        inputs.add(new JLabel("Person ID"));
        ...
        inputs.add(new JLabel("Date of test / date from"));
        inputs.add(this.testDate);
        inputs.add(new JLabel("Date to (max)"));
        inputs.add(this.testDateTo);
        inputs.add(new JLabel("Positive X days after"));
        inputs.add(this.testDaysAfter);
        inputs.add(new JLabel("Person ID"));
        inputs.add(this.testPersonID);
        inputs.add(new JLabel("Test Code"));
        inputs.add(this.testCode);
        inputs.add(new JLabel("Workplace code"));
        inputs.add(this.workplace);
        inputs.add(new JLabel("Region code"));
        inputs.add(this.region);
        inputs.add(new JLabel("District code"));
        inputs.add(this.district);
        inputs.add(new JLabel("Test result"));
        inputs.add(this.testResult);
        inputs.add(new JLabel("Test value"));
        inputs.add(this.testValue);
        inputs.add(new JLabel("Note"));
