...
public class Main {
    public static void main(String[] args) {
        ...
        who.addTestResult(LocalDate.of(2022, 8, 7), "2", 40, 1, 2, 1, false, 0.0, "This is first one");
        who.addTestResult(LocalDate.of(2022, 8, 7), "2", 8, 1, 2, 1, true, 1.0, "");
        who.addTestResult(LocalDate.of(2022, 8, 7), "2", 2, 1, 2, 2, true, 4.0, "dhshgghsghsgsg sgtrh rth rth ");
        who.addTestResult(LocalDate.of(2022, 8, 6), "2", 85, 1, 2, 1, true, 0.5, "");
